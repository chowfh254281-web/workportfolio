...
export default function PhotographyPage() {
  ...
  useEffect(() => {
    ...
    const initDesktopAnimation = () => {
      ...
      const calculateWidth = () => {
        if (rows[0]) {
            ...
            // Calculate width of the first 5 unique items (One Set)
            for(let i = 0; i < 5; i++) {
            ...
            // Reset Right Moving Rows offset to ensure seamless loop
            ...
            // Show wrapper once calculations are done
      ...
      const animate = () => {
        ...
        const limit = singleSetWidth || 3000; // Fallback
        ...
        pos6 += speed; if (pos6 >= 0) pos6 -= limit; if (pos6 < -limit) pos6 += limit;
      ...
      // Wait for images to load for accurate width calculation
    ...
    // Determine Logic based on screen width
    ...
    <>
      ...
      <style jsx global>{`
        ...
        * { box-sizing: border-box; }
        ...
        /* Pattern Logic: 5-Item Loop Safe Pattern */
        .strip-item { 
        ...
        /* 2nd & 5th items are Wide (4:3) */
        .strip-item:nth-child(5n+2), .strip-item:nth-child(5n+5) { aspect-ratio: 4/3; }
        ...
        @media (max-width: 768px) {
            ...
            .kinetic-wrapper { gap: 20px; padding: 0 20px 100px 20px; display: block; opacity: 1; }
            ...
            .strip-item { width: 100%; height: auto; aspect-ratio: auto; max-width: none; filter: brightness(0.9); }
